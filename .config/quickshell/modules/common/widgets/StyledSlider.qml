...
Slider {
    ...
    property bool wavy
    property bool wavyState: true
    property var configuration: wavy ? 4 : StyledSlider.Configuration.S
    ...
    property real trackRadius: trackWidth >= StyledSlider.Configuration.XL ? 21
        ...
        : height / 2
    property real handleHeight: wavy ? 18 : Math.max(33, trackWidth + 9)
    ...
    background: Item {
        ...
        Loader {
            ...
            sourceComponent: WavyLine {
                ...
                amplitudeMultiplier: root.wavyState ? 0.5 : 0
                width: root.handleMargins + (root.visualPosition * root.effectiveDraggingWidth) - (root.handleWidth / 2 + root.handleMargins)
                height: root.trackWidth
                Connections {
                    target: root
