...
Rectangle {
    ...
    property int selectedTab: Persistent.states.timeMenu.bottomGroup.tab
    property bool collapsed: Persistent.states.timeMenu.bottomGroup.collapsed
    property var tabs: [
        {
            "type": "calendar",
            "name": "Calendar",
    ...
    function setCollapsed(state) {
        Persistent.states.timeMenu.bottomGroup.collapsed = state;
        if (collapsed) {
                ...
                Repeater {
                    ...
                    NavigationRailButton {
                        ...
                        onPressed: {
                            ...
                            Persistent.states.timeMenu.bottomGroup.tab = index;
                        }
                    }
                }
            }
