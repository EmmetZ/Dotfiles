...
Item {
    ...
    property list<var> pinnedItems: SystemTray.items.values
    ...
    GridLayout {
        ...
        //         color: {
        //             if (Config.options.bar.m3theme) {
        //                 return root.trayOverflowOpen ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnLayer2
        //             }
        //             return root.trayOverflowOpen ? Appearance.mocha.text : Appearance.mocha.subtext1
        //         }
